...
export class Migration20220725133443 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "agent" ("id" varchar(255) not null, "did" varchar(255) not null, "delivery_type" text check ("delivery_type" in (\'Push\', \'WebHook\')) null, "delivery_data" varchar(255) null, "live_delivery" boolean not null);');
